...
* chore: add test-matrix.yml by @WatheqAlshowaiter in https://github.com/WatheqAlshowaiter/backup-tables/pull/22
* chore(deps): bump dependabot/fetch-metadata from 2.4.0 to 2.5.0 by @dependabot[bot] in https://github.com/WatheqAlshowaiter/backup-tables/pull/24
* chore(deps): bump nick-fields/retry from 3 to 4 by @dependabot[bot] in https://github.com/WatheqAlshowaiter/backup-tables/pull/25
* chore(deps): bump dependabot/fetch-metadata from 2.5.0 to 3.1.0 by @dependabot[bot] in https://github.com/WatheqAlshowaiter/backup-tables/pull/27
* feat: support laravel 13 by @WatheqAlshowaiter in https://github.com/WatheqAlshowaiter/backup-tables/pull/28

**Full Changelog**: https://github.com/WatheqAlshowaiter/backup-tables/compare/1.5.3...1.5.4
